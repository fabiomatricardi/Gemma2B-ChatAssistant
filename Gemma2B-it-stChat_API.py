...
st.set_page_config(
    page_title="Your own LocalGPT with 💎 Gemma-2B-it",
    page_icon="💎",
    layout="wide")

# Create a header element
st.header("Your own LocalGPT with 💎 Gemma-2B-it")
st.markdown("#### :green[*Gemma-2b-it Q4 GGUF - the best 2B model?*]")
...
## Logger file
    ...
    writehistory(st.session_state.logfilename,f'Your own LocalGPT with 💎 Gemma-2B-it\n---\n🧠🫡: You are a helpful assistant.')    
